...
})(AccStatusChange || (AccStatusChange = {}));
/** @example "cskip_no_state" */
export var ComputeSkipReason;
...
})(ComputeSkipReason || (ComputeSkipReason = {}));
/** @example "cskip_no_state" */
export var BouncePhaseType;
...
})(BouncePhaseType || (BouncePhaseType = {}));
export var JettonVerificationType;
...
})(JettonVerificationType || (JettonVerificationType = {}));
export var PoolImplementationType;
...
})(PoolImplementationType || (PoolImplementationType = {}));
...
export class Api {
  ...
  blockchain = {
     ...
     */
    getBlockchainRawAccount: (accountId, params = {}) =>
      this.http.request({
     ...
     */
    getBlockchainAccountTransactions: (accountId, query, params = {}) =>
      this.http.request({
     ...
     */
    execGetMethodForBlockchainAccount: (accountId, methodName, query, params = {}) =>
      this.http.request({
     ...
     */
    blockchainAccountInspect: (accountId, params = {}) =>
      this.http.request({
  ...
  emulation = {
     ...
     */
    emulateMessageToAccountEvent: (accountId, data, params = {}) =>
      this.http.request({
  ...
  accounts = {
     ...
     */
    accountDnsBackResolve: (accountId, params = {}) =>
      this.http.request({
     ...
     */
    getAccountJettonsHistory: (accountId, query, params = {}) =>
      this.http.request({
     ...
     */
    getAccountJettonHistoryById: (accountId, jettonId, query, params = {}) =>
      this.http.request({
     ...
     */
    getAccountNftItems: (accountId, query, params = {}) =>
      this.http.request({
     ...
     */
    getAccountEvents: (accountId, query, params = {}) =>
      this.http.request({
     ...
     */
    getAccountEvent: (accountId, eventId, query, params = {}) =>
      this.http.request({
     ...
     */
    getAccountTraces: (accountId, query, params = {}) =>
      this.http.request({
     ...
     */
    reindexAccount: (accountId, params = {}) =>
      this.http.request({
     ...
     */
    getAccountDnsExpiring: (accountId, query, params = {}) =>
      this.http.request({
     ...
     */
    getAccountPublicKey: (accountId, params = {}) =>
      this.http.request({
     ...
     */
    getAccountDiff: (accountId, query, params = {}) =>
      this.http.request({
  ...
  nft = {
     ...
     */
    getAccountNftHistory: (accountId, query, params = {}) =>
      this.http.request({
     ...
     */
    getNftCollection: (accountId, params = {}) =>
      this.http.request({
     ...
     */
    getItemsFromCollection: (accountId, query, params = {}) =>
      this.http.request({
     ...
     */
    getNftItemByAddress: (accountId, params = {}) =>
      this.http.request({
     ...
     */
    getNftHistoryById: (accountId, query, params = {}) =>
      this.http.request({
  ...
  jettons = {
     ...
     */
    getJettonInfo: (accountId, params = {}) =>
      this.http.request({
     ...
     */
    getJettonHolders: (accountId, query, params = {}) =>
      this.http.request({
  ...
  staking = {
     ...
     */
    getAccountNominatorsPools: (accountId, params = {}) =>
      this.http.request({
     ...
     */
    getStakingPoolInfo: (accountId, params = {}) =>
      this.http.request({
     ...
     */
    getStakingPoolHistory: (accountId, params = {}) =>
      this.http.request({
  ...
  wallet = {
     ...
     */
    getAccountSeqno: (accountId, params = {}) =>
      this.http.request({
  ...
  liteServer = {
     ...
     */
    getRawTransactions: (accountId, query, params = {}) =>
      this.http.request({
