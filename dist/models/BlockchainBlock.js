...
exports.BlockchainBlockToJSON = exports.BlockchainBlockFromJSONTyped = exports.BlockchainBlockFromJSON = exports.instanceOfBlockchainBlock = void 0;
const runtime_1 = require("../runtime");
/**
 * Check if a given object implements the BlockchainBlock interface.
 */
function instanceOfBlockchainBlock(value) {
    let isInstance = true;
...
exports.instanceOfBlockchainBlock = instanceOfBlockchainBlock;
function BlockchainBlockFromJSON(json) {
    return BlockchainBlockFromJSONTyped(json, false);
}
exports.BlockchainBlockFromJSON = BlockchainBlockFromJSON;
function BlockchainBlockFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'genSoftwareVersion': !(0, runtime_1.exists)(json, 'gen_software_version') ? undefined : json['gen_software_version'],
        'genSoftwareCapabilities': !(0, runtime_1.exists)(json, 'gen_software_capabilities') ? undefined : json['gen_software_capabilities'],
        'masterRef': !(0, runtime_1.exists)(json, 'master_ref') ? undefined : json['master_ref'],
...
exports.BlockchainBlockFromJSONTyped = BlockchainBlockFromJSONTyped;
function BlockchainBlockToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.BlockchainBlockToJSON = BlockchainBlockToJSON;
