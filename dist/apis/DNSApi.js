...
class DNSApi extends runtime.BaseAPI {
    ...
    dnsResolveRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.DnsRecordFromJSON)(jsonValue));
        });
    }
    /**
     * DNS resolve for domain name
    ...
    getAllAuctionsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.AuctionsFromJSON)(jsonValue));
        });
    }
    /**
     * Get all auctions
    ...
    getDomainBidsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.DomainBidsFromJSON)(jsonValue));
        });
    }
    /**
     * Get domain bids
