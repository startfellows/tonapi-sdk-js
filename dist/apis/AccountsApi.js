...
class AccountsApi extends runtime.BaseAPI {
     ...
     */
    getDnsExpiringRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.accountId === null || requestParameters.accountId === undefined) {
     ...
     * Get expiring .ton dns
     */
    getDnsExpiring(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getDnsExpiringRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
     ...
     */
    getPublicKeyByAccountIDRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            if (requestParameters.accountId === null || requestParameters.accountId === undefined) {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.GetPublicKeyByAccountID200ResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Get public key by account id
     */
    getPublicKeyByAccountID(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getPublicKeyByAccountIDRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
    /**
