...
class BlockchainApi extends runtime.BaseAPI {
     ...
     */
    emulateMessageRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.SendMessageRequestToJSON)(requestParameters.sendMessageRequest),
            }, initOverrides);
     ...
     * Emulate sending message to blockchain
     */
    emulateMessage(requestParameters = {}, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.emulateMessageRaw(requestParameters, initOverrides);
    ...
    execGetMethodRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.MethodExecutionResultFromJSON)(jsonValue));
        });
    }
    /**
     * Execute get method for account
    ...
    getRawAccountRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.RawAccountFromJSON)(jsonValue));
        });
    }
    /**
     * Get low-level information about an account taken directly from the blockchain.
