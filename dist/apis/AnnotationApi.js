...
class AnnotationApi extends runtime.BaseAPI {
     ...
     */
    getAnnotationsByAccountRaw(requestParameters, initOverrides) {
     ...
     * Get annotations for account
     */
    getAnnotationsByAccount(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getAnnotationsByAccountRaw(requestParameters, initOverrides);
