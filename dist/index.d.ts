...
export declare class Api<SecurityDataType extends unknown> {
  ...
  blockchain: {
    ...
    ) => Promise<HttpResponse<BlockchainBlockShards, Error>>;
    /**
    ...
    getBlockchainMasterchainBlocks: (
      masterchainSeqno: number,
      params?: RequestParams,
    ) => Promise<HttpResponse<BlockchainBlocks, Error>>;
    /**
    ...
    getBlockchainConfigFromBlock: (
      masterchainSeqno: number,
      params?: RequestParams,
    ) => Promise<HttpResponse<BlockchainConfig, Error>>;
    /**
    ...
    getRawBlockchainConfigFromBlock: (
      masterchainSeqno: number,
      params?: RequestParams,
    ) => Promise<HttpResponse<RawBlockchainConfig, Error>>;
    /**
     ...
     */
    getRawBlockchainConfig: (params?: RequestParams) => Promise<HttpResponse<RawBlockchainConfig, Error>>;
    /**
  ...
  emulation: {
    ...
    decodeMessage: (
      ...
      params?: RequestParams,
    ) => Promise<HttpResponse<DecodedMessage, Error>>;
    /**
